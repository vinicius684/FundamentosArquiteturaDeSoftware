...
namespace DesignPatterns
{
    internal sealed class LoadBalancer
    {
        ...
        private static readonly LoadBalancer Instance = new LoadBalancer();//por ser static, vai criar um instancia e vai mantê-lá
        ...
        public Server NextServer
        {
            get
            {
                var r = _random.Next(_servers.Count); //gerar um número randomico com base no múmero de servidores que tenho
                return _servers[r];
            }
        }
    }
