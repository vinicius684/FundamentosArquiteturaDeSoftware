...
namespace OOP
{
    ...
    public interface IRepositorio<T>//reps generico
    {
    ...
    public interface IRepositorioPessoa//repos especializado 
    {
    ...
    public class RepositorioComposicaoPessoa : IRepositorioPessoa//Deve ser preferido, menos acomplamento, implemento só aquilo que está no contrato da interface pessoa
    {
